...
// Each gallery card has a UNIQUE user portrait paired with its celeb
// (no more reuse — the manifest USERS now has 8 distinct entries).
const GALLERY = [
  ...
  { n: "Billie Eilish",     p: 89, c: colors.green,  r: -4, user: userImg("user6"), celeb: celebImg("billie")         },
  { n: "Selena Gomez",      p: 92, c: colors.pink,   r: 2,  user: userImg("user7"), celeb: celebImg("selena")         },
  { n: "Harry Styles",      p: 88, c: colors.blue,   r: -5, user: userImg("user8"), celeb: celebImg("harry")          },
];
